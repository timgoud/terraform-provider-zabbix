		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.zabbix_server.test", "unit_time_days"),
					resource.TestCheckResourceAttrSet("data.zabbix_server.test", "unit_time_hours"),
					resource.TestCheckResourceAttrSet("data.zabbix_server.test", "unit_time_minutes"),
					resource.TestCheckResourceAttrSet("data.zabbix_server.test", "unit_time_seconds"),
					resource.TestCheckResourceAttrSet("data.zabbix_server.test", "unit_time_weeks"),
				),
			},
		},
	})
